/*
Deployment script for Manual_ASP_NET_DB
...
GO
:setvar DatabaseName "Manual_ASP_NET_DB"
:setvar DefaultFilePrefix "Manual_ASP_NET_DB"
:setvar DefaultDataPath "C:\Users\b50946\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB"
:setvar DefaultLogPath "C:\Users\b50946\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB"
...
CREATE TABLE [dbo].[Consulta] (
    ...
    CONSTRAINT [PK_Consulta] PRIMARY KEY CLUSTERED ([IdPaciente] ASC, [IdMedico] ASC, [Fecha] ASC)
);
...
ALTER TABLE [dbo].[Consulta]
    ADD CONSTRAINT [FK_Consulta_Paciente] FOREIGN KEY ([IdPaciente]) REFERENCES [dbo].[Paciente] ([Id]) ON DELETE CASCADE;


GO
PRINT N'Creating [dbo].[FK_Consulta_Medico]...';


GO
ALTER TABLE [dbo].[Consulta]
    ADD CONSTRAINT [FK_Consulta_Medico] FOREIGN KEY ([IdMedico]) REFERENCES [dbo].[Medico] ([Id]) ON DELETE CASCADE;
